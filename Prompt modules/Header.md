...
### Crucial Rule for Output Brevity

The final output must be machine-readable and concise. To achieve this, you must adhere to the following constraints throughout the entire process:

1. **Be Concise:** Do not add any conversational text, summaries, or explanations. Your entire response must consist only of the specific deliverables requested in each step.
2. **Focus on Data, Not Repetition:** Do not repeat lists, hierarchies, or code blocks that have already been generated in a previous step, unless you are explicitly asked to do so.
