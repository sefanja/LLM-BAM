...
VALIDATION SUMMARY:
  - Total Violations: 1/210 (0.48%)
  - FAILED Rules: C10
  - PASSED Rules: C1, C2, C3, C4, C5, C6, C7, C8, C9

----------------------------------------------------------------------
                   DETAILED VIOLATION ANALYSIS
----------------------------------------------------------------------

[!!] C10 - Recursive Unique Custodianship: 1/6 (16.67%)
----------------------------------------------------------------------
 * Statement: For every Business Object element at an internal level (not a leaf), there must be exactly one Capability at the same level that has custodianship over it.
 * Rationale: This enforces the Unique Owner principle at every level of abstraction, guaranteeing that accountability for the Business Object's entire lifecycle is clearly and unambiguously defined and recursively delegated throughout the hierarchy. The exception is made at the leaf level to allow for cooperative, phased transformation by multiple operational Capabilities.
 * Examples of violating items: 
   - business-object: Health Product
